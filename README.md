...
_ If Telegram: input Telegram API Token and Chat ID (see Notifications section on how to get credentials)
_ If G-Mail: input G-Mail address and password (see Notifications section for further instructions) 
